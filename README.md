...
v0.1.0 — 8 skill + 5 agent + 6 preset + 4 reference card + 2 hook + 스키마 구현. 훅·스키마는 pytest로 검증(21 passed). **runtime end-to-end는 plugin reload 후 실측 필요.** 자세한 내역은 [CHANGELOG](CHANGELOG.md).
